...
*   **Secure Authentication**: User registration and login system with passwords stored safely as hashes using PBKDF2/SHA256 
...
*   **Modern Web UI**: Built with a clean layout containing grid menus, authentication views, and real-time status alerts (styled in [style.css]
